// Import from local gradingLogicMap.js, which should also use export
import { scienceWeighted, simpleAverage, tripleAverage } from './gradingLogicMap';

export function computeSubjectScore(papers, subjectName) {
